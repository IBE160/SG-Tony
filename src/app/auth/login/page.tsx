 ...
 * Login Page
 *
 * Displays Google OAuth sign-in button for user authentication.
 ...
 * 3. After granting permission, redirected to /auth/callback
...
export default function LoginPage() {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      // No need to setIsLoading(false) here as the page will unload
    } catch (err) {
