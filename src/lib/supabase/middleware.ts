 ...
 *
 * This client is used in Next.js middleware for session validation and token refresh.
 * It handles authentication state before requests reach route handlers.
 *
